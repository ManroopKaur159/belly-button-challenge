...
let slicedYTicks = yticks.slice(0, 10).reverse(); // yticks is based on otu_ids

let barData = [{
    x: slicedSampleValues,   // top 10 and reversed sample_values
    y: slicedYTicks,         // top 10 and reversed yticks
    text: slicedOtuLabels,   // top 10 and reversed otu_labels
    type: 'bar',
    orientation: 'h'
}];
